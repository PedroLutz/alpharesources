    ...
    return (
        <div className="overlay" style={{background: 'rgba(255, 255, 255, 1)'}}>
            <div className="modal centered-container">
                ...
                <p>For a better experience, please navigate the Alpha Management app on a bigger screen. That way, we can guarantee that you're utilyzing the website in the best way possible.</p>
