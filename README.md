...
Desenvolvi o aplicativo STEM Management durante minha participação como competidor do torneio F1 in Schools, na equipe Alpha. 
...
Por último, na rota "Monitoramento", o site gera um relatório de Status do intervalo selecionado, incluindo informações de cronograma e riscos e campos para que o usuário insira análises externas de KPIs e problemas encontrados.
